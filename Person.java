...
public class Person {
    ...
    public static void main(String[] args) {
        ...
        //Season[] loveSeason = {Season.WINTER, Season.SPRING, Season.SUMMER, Season.FALL};

        Person[] chelovechechki = new Person[10];
        for (int i = 0; i < chelovechechki.length; i++) {
            //Person newPeople = new Person(name[new Random().nextInt(name.length)], loveSeason[new Random().nextInt(loveSeason.length)]);
